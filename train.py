...
df, tracks_len_list = concat_all_midi_to_df(
    root_dir='./LOG_4_4', return_tracks_len_list=True)
...
model = build_stateless_lstm(input_window_len=input_window_len, n_feature=n_feature,
                             output_shape=output_shape, dropout=0.5, neurons_per_layer=[32, 32, 32])

# Experiment with different batch_size
# batch_size = 256
es = EarlyStopping(monitor='val_loss', patience=20)
mc = ModelCheckpoint(filepath='./new_encode_1st_try.h5',
